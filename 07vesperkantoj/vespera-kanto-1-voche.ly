\tocItem \markup "La luno (unuvoĉe)"

\score {
	\header {
	  % title = "Vespera kanto (unuvoĉe)" % en REF 2024 estis decidite alinomi la kanton al "La luno" (por aliaj nomoj vidu "Vespera kanto (poemo)" en Vikipedio)
	  title = "La luno (unuvoĉe)"
